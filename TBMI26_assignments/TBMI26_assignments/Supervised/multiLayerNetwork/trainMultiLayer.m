...
for n = 1:numIterations
    ...
    grad_v = (2/numTraining)*(Ytraining - Dtraining)*tranpose(tanh(Wout*Xtraining)); %Calculate the gradient for the output layer
    grad_w = (2/numTraining)*((transpose(Vout)*(Ytraining - Dtraining)).*(1-(tanh(Wout*Xtraining)).^2)*transpose(Xtraining); %..and for the hidden layer.
