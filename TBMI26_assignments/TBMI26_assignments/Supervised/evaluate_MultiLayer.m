...
learningRate = 0.000001; % Change this, Your learningrate
W0 = rand(numHidden, size(Xtraining,1)); % Change this, Initiate your weight matrix W
V0 = rand(size(Dt{1}, 1), numHidden); % Change this, Initiate your weight matrix V
