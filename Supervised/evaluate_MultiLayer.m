...
%numSamplesPerLabelPerBin = 15; % Number of samples per label per bin, set to inf for max number (total number is numLabels*numSamplesPerBin)
...
W0 = (rand(numHidden, size(Xtraining,1)))/50-0.01; % Change this, Initiate your weight matrix W
V0 = (rand(size(Dt{1}, 1), numHidden))/50-0.01; % Change this, Initiate your weight matrix V
